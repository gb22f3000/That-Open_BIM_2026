...
/**
 * Login Component for GB Creation Digital Twin System
...
const Login = ({ onLogin }) => {
  ...
  const handleDemoLogin = (role) => {
    ...
    const demoCredentials = {
      'admin': { username: 'admin@gbcreation.in', password: 'admin123' },
      'control_room': { username: 'control@gbcreation.in', password: 'control123' },
      'maintenance': { username: 'maintenance@gbcreation.in', password: 'maint123' },
      'safety': { username: 'safety@gbcreation.in', password: 'safety123' },
      'viewer': { username: 'viewer@gbcreation.in', password: 'viewer123' }
    };
