...
# GB Creation - Digital Twin BIM Viewer
# Single-click startup script for macOS
# Developed by Gautam Bhardwaj

# Change to the directory where this script is located
cd "$(dirname "$0")"

echo "🏗️  Starting GB Creation - Digital Twin BIM Viewer"
echo "👨‍💻 Developed by Gautam Bhardwaj"
echo "========================================"
...
echo "🚀 Starting GB Creation application..."
echo "📊 Mock server will start on http://localhost:4000"
echo "🌐 Development server will start on http://localhost:3000"
echo ""
echo "🔑 LOGIN CREDENTIALS:"
echo "   Admin:        username: admin@gbcreation.in        password: admin123"
echo "   Control Room: username: control@gbcreation.in     password: control123" 
echo "   Maintenance:  username: maintenance@gbcreation.in password: maint123"
echo "   Safety:       username: safety@gbcreation.in      password: safety123"
echo "   Viewer:       username: viewer@gbcreation.in      password: viewer123"
echo ""
...
echo ""
echo "👋 GB Creation application has been stopped"
