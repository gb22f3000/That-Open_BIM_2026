...
const ControlRoomDashboard = () => {
  ...
  const loadDashboardData = () => {
    ...
    const savedWorkOrders = JSON.parse(localStorage.getItem('ncrtc_work_orders') || '[]');
  ...
  const handleSubmitWorkOrder = (e) => {
    ...
    const existingWorkOrders = JSON.parse(localStorage.getItem('ncrtc_work_orders') || '[]');
    existingWorkOrders.push(newWorkOrder);
    localStorage.setItem('ncrtc_work_orders', JSON.stringify(existingWorkOrders));
